...
<jsp:include page="/principal/head.jsp"></jsp:include>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção das Informação de Ambiente</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsAmbiente" method="post" id="formAmbiente">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Ambiente</span>
																	<input class="form-control text-info font-italic" type="text" name="id_ambiente" id="id_ambiente" readonly="readonly" value="${listAmbiente.id_ambiente}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listAmbiente.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="ambiente" id="ambiente" maxlength="200" class="form-control" required="required" placeholder="Informe o ambiente" value="${listAmbiente.ambiente}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listAmbiente.obs}</textarea>
																</div>
															</div>
										...
										<h4 class="sub-title">Ambiente Cadastradas</h4>
										<div class="row">
											<div class="col-sm-12">
												<!-- Basic Form Inputs card start -->
												<div class="card">
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  ...
															  <tbody>
   					                                              <c:forEach items="${listAmbientes}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_ambiente}" > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}"  > </c:out> </td>
				                                                     <td> <c:out value="${lrc.ambiente}"    > </c:out> </td>
				                                                     <td> <c:out value="${lrc.obs}"         > </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_ambiente} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_ambiente} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formAmbiente").elements;
 ...
 function Delete( idAmbiente ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsAmbiente"; 
	   	 var parametros = "?acao=deletarajax&idAmbiente=" + idAmbiente;
 ...
 function Editar( idAmbiente ) {
   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsAmbiente"; 
   	 var parametros = "?acao=buscarEditar&idAmbiente=" + idAmbiente;
   	 var url = urlAction + parametros;
   	 window.location.href = url;		    
