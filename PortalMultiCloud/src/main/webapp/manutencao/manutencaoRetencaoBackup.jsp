...
<jsp:include page="/principal/head.jsp"></jsp:include>
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção Retenção Backup </h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsRetencaoBackup" method="post" id="formRetencaoBackup">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Retenção Backup</span>
																	<input class="form-control text-info font-italic" type="text" name="id_retencao_backup" id="id_retencao_backup" readonly="readonly" value="${listRetencaoBackup.id_retencao_backup}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listRetencaoBackup.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="retencao_backup" id="retencao_backup" maxlength="50" class="form-control" required="required" placeholder="Informe o Retenção Backup" value="${listRetencaoBackup.retencao_backup}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listRetencaoBackup.observacao}</textarea>
																</div>
															</div>
													...
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  <thead>
															    <tr>
															      <th scope="col">ID Retenção Backup</th>
															  ...
															  <tbody>
   					                                              <c:forEach items="${listRetencaoBackups}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_retencao_backup}" > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}">       </c:out> </td>
				                                                     <td> <c:out value="${lrc.retencao_backup}">        </c:out> </td>
				                                                     <td> <c:out value="${lrc.observacao}">       </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_retencao_backup} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_retencao_backup} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formRetencaoBackup").elements;
 ...
 function Delete( id ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsRetencaoBackup"; 
