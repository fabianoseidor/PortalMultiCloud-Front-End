...
<jsp:include page="/principal/head.jsp"></jsp:include>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção Produto</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsProduto" method="post" id="formProduto">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Produto</span>
																	<input class="form-control text-info font-italic" type="text" name="id_produto" id="id_produto" readonly="readonly" value="${listProduto.id_produto}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listProduto.dt_criacao}">
															...
															<div class="form-row">
			                                                    <!-- Campo Ambiente --> 
			                                                    <div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="font-weight-bold font-italic" style="color: #708090">Produto</span>
																	<input style="color: #B0C4DE" type="text" name="produto" id="produto" maxlength="200" class="form-control" required="required" placeholder="Informe o Status" value="${listProduto.produto}"> 
																	<!-- <label class="float-label">PEP</label> -->
			                                                    </div>
			                                                    <!-- Campo Ambiente --> 
			                                                    <div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="font-weight-bold font-italic" style="color: #708090">valor</span>
																	<input style="color: #B0C4DE" type="text" name="valor" id="valor" maxlength="20" class="form-control" required="required" placeholder="Informe o Status" value="${listProduto.valor}"> 
																	<!-- <label class="float-label">PEP</label> -->
			                                                    </div>
															</div>
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="obs" name="obs" placeholder="Observação" rows="100" >${listProduto.obs}</textarea>
																</div>
															</div>
										...
										<h4 class="sub-title">Tipos Produto</h4>
										<div class="row">
											<div class="col-sm-12">
												<!-- Basic Form Inputs card start -->
												<div class="card">
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  ...
															  <tbody>
   					                                              <c:forEach items="${listProdutos}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_produto}" > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}">  </c:out> </td>
				                                                     <td> <c:out value="${lrc.produto}">     </c:out> </td>
				                                                     <td> <c:out value="${lrc.valor}">       </c:out> </td>
				                                                     <td> <c:out value="${lrc.obs}">         </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_produto} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_produto} )">
 ...
 function Delete( id ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsProduto"; 
