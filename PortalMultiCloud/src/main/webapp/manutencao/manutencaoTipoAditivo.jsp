...
<jsp:include page="/principal/head.jsp"></jsp:include>
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção do Tipo Aditivo </h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsTipoAditivo" method="post" id="formTipoAditivo">
															...
															<div class="form-row">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="id_tipo_aditivo" id="id_tipo_aditivo" readonly="readonly" value="${listTipoAditivo.id_tipo_aditivo}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listTipoAditivo.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="desc_tipo_ditivo" id="desc_tipo_ditivo" maxlength="200" class="form-control" required="required" placeholder="Informe o tipo aditivo" value="${listTipoAditivo.desc_tipo_ditivo}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listTipoAditivo.observacao}</textarea>
																</div>
															</div>
													...
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  <thead>
															    <tr>
															      <th scope="col">ID Tipo Aditivo</th>
															  ...
															  <tbody>
   					                                              <c:forEach items="${listTipoAditivos}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_tipo_aditivo}" > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}">       </c:out> </td>
				                                                     <td> <c:out value="${lrc.desc_tipo_ditivo}">        </c:out> </td>
				                                                     <td> <c:out value="${lrc.observacao}">       </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_tipo_aditivo} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_tipo_aditivo} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formTipoAditivo").elements;
 ...
 function Delete( id ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsTipoAditivo"; 
