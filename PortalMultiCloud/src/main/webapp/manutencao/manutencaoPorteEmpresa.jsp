...
<jsp:include page="/principal/head.jsp"></jsp:include>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção Porte Empresa</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsPorteEmpresa" method="post" id="formPorteEmpresa">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Porte Empresa</span>
																	<input class="form-control text-info font-italic" type="text" name="id_porte" id="id_porte" readonly="readonly" value="${listPorteEmpresa.id_porte}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listPorteEmpresa.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	<span class="font-weight-bold font-italic" style="color: #708090">Porte Empresa</span>
																	<input style="color: #B0C4DE" type="text" name="porte_empresa" id="porte_empresa" maxlength="80" class="form-control" required="required" placeholder="Informe o Porte Empresa" value="${listPorteEmpresa.porte_empresa}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listPorteEmpresa.observacao}</textarea>
																</div>
															</div>
										...
										<h4 class="sub-title">Tipos Porte Empresa</h4>
										<div class="row">
											<div class="col-sm-12">
												<!-- Basic Form Inputs card start -->
												<div class="card">
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  <thead>
															    <tr>
															      <th scope="col">ID Porte Empresa</th>
															      <th scope="col">Data Criação    </th>
															      <th scope="col">Porte Empresa   </th>
															      <th scope="col">Obs.            </th>
															  ...
															  <tbody>
   					                                              <c:forEach items="${listPorteEmpresas}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_porte}" >     </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}">    </c:out> </td>
				                                                     <td> <c:out value="${lrc.porte_empresa}"> </c:out> </td>
				                                                     <td> <c:out value="${lrc.observacao}">    </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_porte} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_porte} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formPorteEmpresa").elements;
 ...
 function Delete( id ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsPorteEmpresa"; 
