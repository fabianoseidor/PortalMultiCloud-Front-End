...
<jsp:include page="/principal/head.jsp"></jsp:include>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção dos Serviço Contratado</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsServicoContratado" method="post" id="formServicoContratado">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Tipo Serviço</span>
																	<input class="form-control text-info font-italic" type="text" name="id_servico_contratado" id="id_servico_contratado" readonly="readonly" value="${listServicoContratado.id_servico_contratado}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listServicoContratado.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="desc_servico" id="desc_servico" maxlength="200" class="form-control" required="required" placeholder="Informe o ambiente" value="${listServicoContratado.desc_servico}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listServicoContratado.obs}</textarea>
																</div>
															</div>
										...
										<h4 class="sub-title">Tipos de Serviços Contratados</h4>
										<div class="row">
											<div class="col-sm-12">
												<!-- Basic Form Inputs card start -->
												<div class="card">
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  <thead>
															    <tr>
															      <th scope="col">ID Serviço Contratado</th>
															  ...
															  <tbody>
   					                                              <c:forEach items="${listServicoContratados}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_servico_contratado}" > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}"            > </c:out> </td>
				                                                     <td> <c:out value="${lrc.desc_servico}"          > </c:out> </td>
				                                                     <td> <c:out value="${lrc.obs}"                   > </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_servico_contratado} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_servico_contratado} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formServicoContratado").elements;
 ...
 function Delete( id ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsServicoContratado"; 
