...
<jsp:include page="/principal/head.jsp"></jsp:include>
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção Status Recurso</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsStatusRecurso" method="post" id="formStatusRecurso">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Status Recurso</span>
																	<input class="form-control text-info font-italic" type="text" name="id_status_recurso" id="id_status_recurso" readonly="readonly" value="${listStatusRecurso.id_status_recurso}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listStatusRecurso.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	<span class="font-weight-bold font-italic" style="color: #708090">Status Recurso</span>
																	<input style="color: #B0C4DE" type="text" name="status_recurso" id="status_recurso" maxlength="200" class="form-control" required="required" placeholder="Informe o Status Recurso" value="${listStatusRecurso.status_recurso}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listStatusRecurso.observacao}</textarea>
																</div>
															</div>
													...
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  <thead>
															    <tr>
															      <th scope="col">ID Status Recurso</th>
															  ...
															  <tbody>
   					                                              <c:forEach items="${listStatusRecursos}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_status_recurso}" > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}">         </c:out> </td>
				                                                     <td> <c:out value="${lrc.status_recurso}">     </c:out> </td>
				                                                     <td> <c:out value="${lrc.observacao}">         </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_status_recurso} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_status_recurso} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formStatusRecurso").elements;
 ...
 function Delete( id ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsStatusRecurso"; 
