...
<jsp:include page="/principal/head.jsp"></jsp:include>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção Status Cliente</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsStatusCliente" method="post" id="formStatusCliente">
															...
															<div class="form-row">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="id_status" id="id_status" readonly="readonly" value="${listStatusCliente.id_status}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listStatusCliente.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="status" id="status" maxlength="45" class="form-control" required="required" placeholder="Informe o Status" value="${listStatusCliente.status}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listStatusCliente.observacao}</textarea>
																</div>
															</div>
										...
										<h4 class="sub-title">Tipos Status Cliente</h4>
										<div class="row">
											<div class="col-sm-12">
												<!-- Basic Form Inputs card start -->
												<div class="card">
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  <thead>
															    <tr>
															      <th scope="col">ID Status Cliete </th>
															      <th scope="col">Data Criação     </th>
															      <th scope="col">Status Cliete    </th>
															      <th scope="col">Obs.             </th>
															  ...
															  <tbody>
   					                                              <c:forEach items="${listStatusClientes}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_status}" > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}"> </c:out> </td>
				                                                     <td> <c:out value="${lrc.status}">     </c:out> </td>
				                                                     <td> <c:out value="${lrc.observacao}"> </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_status} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_status} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formStatusCliente").elements;
 ...
 function Delete( id ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsStatusCliente"; 
