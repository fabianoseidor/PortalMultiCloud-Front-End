...
<jsp:include page="/principal/head.jsp"></jsp:include>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção Nuvem</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsNuvem" method="post" id="formNuvem">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Nuvem</span>
																	<input class="form-control text-info font-italic" type="text" name="id_nuvem" id="id_nuvem" readonly="readonly" value="${listNuvem.id_nuvem}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listNuvem.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="mome_parceiro" id="mome_parceiro" maxlength="45" class="form-control" required="required" placeholder="Informe a Nuvem" value="${listNuvem.mome_parceiro}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listNuvem.observacao}</textarea>
																</div>
															</div>
										...
										<h4 class="sub-title">Tipos de Nuvem</h4>
										<div class="row">
											<div class="col-sm-12">
												<!-- Basic Form Inputs card start -->
												<div class="card">
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  ...
															  <tbody>
   					                                              <c:forEach items="${listNuvems}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_nuvem}"       > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}"     > </c:out> </td>
				                                                     <td> <c:out value="${lrc.mome_parceiro}"  > </c:out> </td>
				                                                     <td> <c:out value="${lrc.observacao}"     > </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_nuvem} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_nuvem} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formNuvem").elements;
 ...
 function Delete( id ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsNuvem"; 
