...
<jsp:include page="/principal/head.jsp"></jsp:include>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção Sistema Operacional</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsSistemaOperacional" method="post" id="formSistemaOperacional">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID SO</span>
																	<input class="form-control text-info font-italic" type="text" name="id_so" id="id_so" readonly="readonly" value="${listSistemaOperacional.id_so}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listSistemaOperacional.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="sistema_operacional" id="sistema_operacional" maxlength="200" class="form-control" required="required" placeholder="Informe o Sistema Operacional" value="${listSistemaOperacional.sistema_operacional}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listSistemaOperacional.obs}</textarea>
																</div>
															</div>
										...
										<h4 class="sub-title">Tipos de Sistema Operacional Cadastrados</h4>
										<div class="row">
											<div class="col-sm-12">
												<!-- Basic Form Inputs card start -->
												<div class="card">
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  ...
															  <tbody>
   					                                              <c:forEach items="${listSistemaOperacionals}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_so}"               > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}"          > </c:out> </td>
				                                                     <td> <c:out value="${lrc.sistema_operacional}" > </c:out> </td>
				                                                     <td> <c:out value="${lrc.obs}"                 > </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_so} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_so} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formSistemaOperacional").elements;
 ...
 function Delete( idSO ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsSistemaOperacional"; 
	   	 var parametros = "?acao=deletar&idSO=" + idSO;
	   	 var url = urlAction + parametros;
	   	 window.location.href = url;	    
    }
}

 function Editar( idSO ) {
   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsSistemaOperacional"; 
   	 var parametros = "?acao=buscarEditar&idSO=" + idSO;
   	 var url = urlAction + parametros;
   	 window.location.href = url;		    
