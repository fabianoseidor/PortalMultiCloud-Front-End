...
<jsp:include page="/principal/head.jsp"></jsp:include>
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														<h4 class="sub-title">Manutenção Tipo Rascunho</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsTipoRascunho" method="post" id="formTipoRascunho">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Tipo Rascunho</span>
																	<input class="form-control text-info font-italic" type="text" name="id_tipo_rascunho" id="id_tipo_rascunho" readonly="readonly" value="${listTipoRascunho.id_tipo_rascunho}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listTipoRascunho.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="rascunho" id="rascunho" maxlength="200" class="form-control" required="required" placeholder="Informe o Nome Rascunho" value="${listTipoRascunho.rascunho}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="obs" name="obs" placeholder="Observação" >${listTipoRascunho.obs}</textarea>
																</div>
															</div>
													...
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  <thead>
															    <tr>
															      <th scope="col">ID Tipo Rascunho </th>
															  ...
															  <tbody>
   					                                              <c:forEach items="${listTipoRascunhos}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_tipo_rascunho}"> </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}"      > </c:out> </td>
				                                                     <td> <c:out value="${lrc.rascunho}"        > </c:out> </td>
				                                                     <td> <c:out value="${lrc.obs}"             > </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_tipo_rascunho} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_tipo_rascunho} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formTipoRascunho").elements;
 ...
 function Delete( idTipoRascunho ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsTipoRascunho"; 
	   	 var parametros = "?acao=deletarajax&idTipoRascunho=" + idTipoRascunho;
	   	 var url = urlAction + parametros;
	   	 window.location.href = url;	    
    }
}

 function Editar( idTipoRascunho ) {
   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsTipoRascunho"; 
   	 var parametros = "?acao=buscarEditar&idTipoRascunho=" + idTipoRascunho;
   	 var url = urlAction + parametros;
   	 window.location.href = url;		    
