...
<jsp:include page="/principal/head.jsp"></jsp:include>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Manutenção Status Contrato</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletsStatusContrato" method="post" id="formStatusContrato">
                                                            
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Status Contrato</span>
																	<input class="form-control text-info font-italic" type="text" name="id_status_contrato" id="id_status_contrato" readonly="readonly" value="${listStatusContrato.id_status_contrato}">
																...
																<div class="form-group form-default form-static-label col-md-6 mb-6">
																	...
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao" id="dt_criacao" readonly="readonly" value="${listStatusContrato.dt_criacao}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="status_contrato" id="status_contrato" maxlength="45" class="form-control" required="required" placeholder="Informe o Status Contrato" value="${listStatusContrato.status_contrato}"> 
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${listStatusContrato.observacao}</textarea>
																</div>
															</div>
										...
										<h4 class="sub-title">Tipos Status Recurso</h4>
										<div class="row">
											<div class="col-sm-12">
												<!-- Basic Form Inputs card start -->
												<div class="card">
													<div class="card-block">
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
															...
															<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm">
															  <thead>
															    <tr>
															      <th scope="col">ID Status Contrato</th>
															  ...
															  <tbody>
   					                                              <c:forEach items="${listStatusContratos}" var="lrc">
				                                                   <tr>
				                                                     <td> <c:out value="${lrc.id_status_contrato}" > </c:out> </td>
				                                                     <td> <c:out value="${lrc.dt_criacao}">         </c:out> </td>
				                                                     <td> <c:out value="${lrc.status_contrato}">     </c:out> </td>
				                                                     <td> <c:out value="${lrc.observacao}">         </c:out> </td>
				                                                     <td>
																		<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_status_contrato} );">
																	...
																	<td>
																	    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_status_contrato} )">
 ...
 function AlerataMensagensModal( iconi, tituloPrincipal, textoPrincipal ) {
	  Swal.fire({
		    icon  : iconi                             ,
 ...
 function limparForm() {
		var elementos = document.getElementById("formStatusContrato").elements;
 ...
 function Delete( id ) {
	 ...
	 if(id === 1 ){
		 AlerataMensagensModal( "info", "Informativo!", "O registro 'Ativo' não pode ser Excluido!" );
	 }else{
		 Swal.fire({
			  title: "Deletar",
			  ...
			  if (result.isConfirmed) {
				   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsStatusContrato"; 
...
*/    
 ...
 function Editar( id ) {
	 ...
	 if(id === 1 ){
		 AlerataMensagensModal( "info", "Informativo!", "O registro 'Ativo' não pode ser Editado!" );
	 }else{
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServletsStatusContrato"; 
