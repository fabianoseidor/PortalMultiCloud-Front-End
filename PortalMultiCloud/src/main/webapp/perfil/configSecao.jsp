...
<jsp:include page="/principal/head.jsp"></jsp:include>
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Configuração Seção</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServeletSecao" method="post" id="formSecao">
                                                           
															<div class="form-row">
																<!-- Campo ID Contrato -->
																<div class="form-group form-default form-static-label col-md-4 mb-6">
																	<span class="text-info font-weight-bold font-italic">ID Seção</span>
																	<input class="form-control text-info font-italic" type="text" name="id_secao" id="id_secao" readonly="readonly" value="${modelSecao.id_secao}">
																</div>
																<!-- Data Cadastro -->
																<div class="form-group form-default form-static-label col-md-4 mb-6">
																    <span  class="text-info font-weight-bold font-italic">Data Cadastro</span>
																	<input class="form-control text-info font-italic" type="text" name="dt_criacao"    id="dt_criacao"    readonly="readonly" value="${modelSecao.dt_criacao}">
																</div>
																<!-- Login Cadastro --> 
			                                                    <div class="form-group form-default form-static-label col-md-4 mb-6">
			                                                        <span  class="text-info font-weight-bold font-italic">Login Cadastro</span>
			                                                        <input class="form-control text-info font-italic" type="text" name="user_cadastro" id="user_cadastro" readonly="readonly" value="${modelSecao.user_cadastro}">
															...
															<div class="form-row">
			                                                    ...
			                                                    <div class="form-group form-default form-static-label col-md-12 mb-6">
																	...
																	<input style="color: #B0C4DE" type="text" name="nome_secao" id="nome_secao" maxlength="150" class="form-control" required="required" placeholder="Informe a Seção" value="${modelSecao.nome_secao}"> 
												               </div>
															</div>
															...
															<div class="form-row">
															    <div class="form-group form-default form-static-label col-md-12 mb-12">
																	...
																	<textarea style="color: #B0C4DE" class="form-control" id="observacao" name="observacao" placeholder="Observação" rows="100" >${modelSecao.obs}</textarea>
																</div>
															</div>
														...
														<div class="tab-pane fade show active" id="recurso" role="tabpanel" aria-labelledby="recurso-tab">
                                                             <div style="height: 300px; overflow: scroll;">
																<table class="table table-striped">
																  <thead>
																    <tr>
																      <th scope="col">ID Seção      </th>
																      <th scope="col">Data Criação  </th>
																      <th scope="col">Nome Seção    </th>
																      <th scope="col">User Cadastro </th>
																      <th scope="col">Editar        </th>
																      <th scope="col">Deletar       </th>
																    </tr>
																  </thead>
																  <tbody>
	   					                                              <c:forEach items="${listSecaos}" var="lrc">
					                                                   <tr>
					                                                     <td> <c:out value="${lrc.id_secao}"      > </c:out> </td>
					                                                     <td> <c:out value="${lrc.dt_criacao}"    > </c:out> </td>
					                                                     <td> <c:out value="${lrc.nome_secao}"    > </c:out> </td>
					                                                     <td> <c:out value="${lrc.user_cadastro}" > </c:out> </td>
					                                                     <td>
																			<button type="button" class="btn btn-primary" onclick="Editar( ${lrc.id_secao} );">
																		...
																		<td>
																		    <button type="button" class="btn btn-danger" onclick="Delete ( ${lrc.id_secao} )">
 ...
 function limparForm() {
		var elementos = document.getElementById("formSecao").elements;
 ...
 function Delete( idSecao ) {
    if(confirm('Deseja realmente excluir os dados?')) {    	
	   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServeletSecao"; 
	   	 var parametros = "?acao=deletarajax&idSecao=" + idSecao;
	   	 var url = urlAction + parametros;
	   	 window.location.href = url;	    
    }
}

 function Editar( idSecao ) {
   	 var urlAction  =  window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/ServeletSecao"; 
   	 var parametros = "?acao=buscarEditar&idSecao=" + idSecao;
   	 var url = urlAction + parametros;
   	 window.location.href = url;		    
