<%@page import="br.com.portal.model.ModelRecursoAditivo"%>
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<h4 class="sub-title">Recursos Aditivo</h4>
														<form class="form-material" action="<%= request.getContextPath() %>/ServletRecursoAditivo" method="post" id="formRetencaoContrato">
																<hr>  
																<br>
																...
																<div class="form-row">
																	...
																	<div class="form-group form-default form-static-label col-md-6 mb-6">
																		<input type="text" name="id_recurso" id="id_recurso" class="form-control" readonly="readonly" value="${modelRecursoAditivo.id_recurso}">
																		<span class="form-bar"></span> 
																		<label class="float-label">ID Recurso</label>
																	</div>
																	<!-- Data Cadastro -->
																	<div class="form-group form-default form-static-label col-md-6 mb-6">
																		<input type="text" name="dt_cadastro" id="dt_cadastro" class="form-control" readonly="readonly" value="${modelRecursoAditivo.dt_cadastro}">
																		<span class="form-bar">
																...
																<div class="form-row">
																	...
																	<div class="form-group form-default form-static-label col-md-3 mb-6">
																		<input type="text" name="id_contrato" id="id_contrato" style="background: #789bd5; color:#ffffff" class="form-control font-weight-bold font-italic" readonly="readonly" value="${modelRecursoAditivo.id_contrato}">
																		<span class="form-bar"></span> 
																		<label class="float-label">ID Contrato</label>
																	</div>
																	<!-- Campo ID Aditivado -->
																	<div class="form-group form-default form-static-label col-md-3 mb-6">
																		<input type="text" name="id_aditivado" id="id_aditivado" style="background: #789bd5; color:#ffffff" class="form-control font-weight-bold font-italic" readonly="readonly" value="${modelRecursoAditivo.id_aditivado}">
																		<span class="form-bar"></span> 
																		<label class="float-label">ID Aditivado</label>
																	</div>

																	<!-- Campo ID Cliente -->
																	<div class="form-group form-default form-static-label col-md-3 mb-6">
																		<input type="text" name="id_cliente" id="id_cliente" style="background: #789bd5; color:#ffffff" class="form-control font-weight-bold font-italic" readonly="readonly" value="${modelRecursoAditivo.id_cliente}">
																		<span class="form-bar"></span> 
																	...
																	<!-- Nome Cliente -->
																	<div class="form-group form-default form-static-label col-md-3 mb-6">
																		<input type="text" name="nomeCliente" id="nomeCliente" style="background: #789bd5; color:#ffffff" class="form-control font-weight-bold font-italic" readonly="readonly" value="${modelRecursoAditivo.nomeCliente}">
																		<span class="form-bar">
																...
																<div class="form-row">
																	...
																	<div class="form-group form-default form-static-label col-md-4 mb-6">
																		<select name=id_status_recurso id="id_status_recurso" class="form-control" required="required">
																			<option value="" disabled selected>Selecione Status</option>
																			        <tagsContrato:listaStatusRecursoAditivo />
																	...
																	<!-- Campo TAG Vcenter -->
																	<div class="form-group form-default form-static-label col-md-4 mb-6">
			                                                             <input type="text" name="tag_vcenter" id="tag_vcenter" class="form-control" required="required" placeholder="TAG da Instancia no Vcenter" value="${modelRecursoAditivo.tag_vcenter}">
			                                                             <span class="form-bar"></span>
																	...
																	<div class="form-group form-default form-static-label col-md-3 mb-4">
																		<select name="id_tipo_disco" id="id_tipo_disco" class="form-control" required="required" >
																			<option value="" disabled selected>Selecione Tipo Disco</option>
																			        <tagsContrato:listaTipoDiscoAditivo />
																	...
																	<div class="form-group form-default form-static-label col-md-3 mb-4">
																		<select name="id_so" id="id_so" class="form-control" required="required">
																			<option value="" disabled selected>Selecione Sistema Operacional</option>
																			      <tagsContrato:listaSistemaOperacionalAditivo /> 
																	...
																	<div class="form-group form-default form-static-label col-md-3 mb-4">
																		<select name="id_ambiente" id="id_ambiente" class="form-control" required="required">
																			<option value="" disabled selected>Selecione Ambiente</option>
																			       <tagsContrato:listaAmbienteAditivo /> 
																	...
																	<div class="form-group form-default form-static-label col-md-3 mb-4">
																		<select name="id_tipo_servico" id="id_tipo_servico" class="form-control" required="required">
																			<option value="" disabled selected>Selecione Tipo Serviço</option>
																			        <tagsContrato:listaTipoServicoAditivo />
																...
																<div class="form-row">
																	<!-- Campo ID Contrato -->
																	<div class="form-group form-default form-static-label col-md-6 mb-6">
																		<input type="text" name="id_nuvem" id="id_nuvem" style="background: #789bd5; color:#ffffff" class="form-control font-weight-bold font-italic" readonly="readonly" value="${modelRecursoAditivo.nuvem}">
																		<span class="form-bar"></span> 
																	...
																	<div class="form-group form-default form-static-label col-md-6 mb-4">
																		<select name="id_familia_flavors" id="id_familia_flavors" class="form-control" required="required">
																			<option value="" disabled selected>Selecione Família Flavors</option>
																			        <tagsContrato:listaFamiliaFlavoresAditivo/>
															    ...
															    <div class="form-group form-default form-static-label mb-6">
																	...
																	<textarea class="form-control" id="obs" name="obs" placeholder="Observações" rows="100" >${modelRecursoAditivo.obs}</textarea>
																</div>
													        ...
													        <a href="<%= request.getContextPath() %>/ServletAditivo?acao=buscarEditar&idAditivo=${modelRecursoAditivo.id_aditivado}" class="btn btn-light float-right mesmo-tamanho-botao" id="btvoltarcontrato" >Voltar para Aditivo</a>
															  ...
															  <tbody>
					                                              ...
					                                              <c:forEach items="${modelRecContRels}" var="tl">
					                                                   <tr>
					                                                     ...
					                                                     <td> <c:out value="${tl.id_contrato}">         </c:out> </td>
					                                                     <td> <c:out value="${tl.id_aditivado}">        </c:out> </td>
					                                                     ...
					                                                     <td><a type="button" class="btn btn-info" href="<%= request.getContextPath() %>/ServletRecursoAditivo?acao=buscarEditar&idContrato=${tl.id_contrato}&idRecurso=${tl.id_recurso}&idAditivo=${tl.id_aditivado}">Editar</a></td>
					                                                   </tr>
					                                              </c:forEach>
...
function limparForm() {
	...
	for(p = 0; p < elementos.length; p++){
		if( elementos[p].id != "id_cliente"  && elementos[p].id != "nomeCliente" && 
			elementos[p].id != "id_contrato" && elementos[p].id != "id_nuvem"    && 
			elementos[p].id != "id_aditivado" ){
		    elementos[p].value = '';
		}
	}
}
