...
<%
   String selected = "";
   List<ModelProduto> modelProdutos = beanProduto.getListaProdutoVPN();
   ...
   if( listAditivoProduto != null ) {
	   if(listAditivoProduto.getId_tipo_protudo_contratado() != null )
		   idTipoProdutoRecuperado = listAditivoProduto.getId_tipo_protudo_contratado();
   }
